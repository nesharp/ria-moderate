...
export const formSchema = z.object({
    ...
    isDamaged: z.boolean(),
    isAbroad: z.boolean(),
    price: z.string().min(1, { message: 'Введіть ціну:' }),
    ...
    year: z.number().min(1, { message: 'Введіть рік:' }),
    run: z.number().min(1, { message: 'Введіть пробіг:' }),
    engineType: z.string().min(1, { message: 'Оберіть тип двигуна:' }),
    engineCP: z.number().min(1, { message: 'Введіть потужність двигуна:' }),
